// TODO This is a React functional component that displays a number of stars based on a rating. The number of full stars, half stars, and empty stars are calculated based on the rating. The stars are displayed as SVGs. The size of the SVGs is passed as a prop and is used as the width and height. The colors of the SVGs are set to gold.
